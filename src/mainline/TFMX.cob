       ...
       PROGRAM-ID. TFMX.
      *==========================================================
      * FASE 10: INGESTA DINÁMICA A RÉPLICAS (TF01 - TF06)
      * Soporta balanceo de carga y trazabilidad bancaria
      *==========================================================
      ...
      **********************************************************************
       01 SQL-STMT-0.
           ...
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF01 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
       01 SQL-STMT-1.
           05 SQL-IPTR   POINTER VALUE NULL.
           05 SQL-PREP   PIC X VALUE 'N'.
           ...
           05 SQL-PARMS  PIC S9(4) COMP-5 VALUE 6.
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF02 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
       01 SQL-STMT-2.
           05 SQL-IPTR   POINTER VALUE NULL.
           ...
           05 SQL-PARMS  PIC S9(4) COMP-5 VALUE 6.
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF03 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
       01 SQL-STMT-3.
           05 SQL-IPTR   POINTER VALUE NULL.
           ...
           05 SQL-PARMS  PIC S9(4) COMP-5 VALUE 6.
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF04 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
       01 SQL-STMT-4.
           05 SQL-IPTR   POINTER VALUE NULL.
           ...
           05 SQL-PARMS  PIC S9(4) COMP-5 VALUE 6.
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF05 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
       01 SQL-STMT-5.
           05 SQL-IPTR   POINTER VALUE NULL.
           ...
           05 SQL-PARMS  PIC S9(4) COMP-5 VALUE 6.
           05 SQL-STMLEN PIC S9(4) COMP-5 VALUE 87.
           05 SQL-STMT   PIC X(87) VALUE 'INSERT INTO TF06 (ID_LOTE,ESTA
      -    'DO,DATOS_TX,REPLICA_NO,CUENTA,MONTO) VALUES (?,?,?,?,?,?)'.
      **********************************************************************
      ...
      *    EXEC SQL END DECLARE SECTION END-EXEC.
       ...
       LINKAGE SECTION.
           COPY LKCIF.
      * Estructura actualizada enviada por el Orquestador TFTRCT
       01  WS-TFFM-VARS.
      ...
      * 1. Preparación de Entorno
           ...
           DISPLAY "TFMX - CARGANDO DESDE : " WS-FILE-NAME

      * 2. Apertura de Archivo Troceado (Generado por TFFILE)
           OPEN INPUT ARCHIVO-ENTRADA
           IF WS-FS NOT = "00"
               DISPLAY "ERROR: NO SE ENCONTRO ARCHIVO " WS-FILE-NAME
      ...
      * Parseo básico para campos de búsqueda rápida (Opcional pero S
           UNSTRING REG-LINEA-ENTRADA DELIMITED BY "|"
           INTO WS-OP-SQL, WS-CUENTA-SQL, WS-MONTO-SQL
      ...
      * El uso de EVALUATE asegura que el SQL sea estático para el prec
      * pero dinámico para la lógica de negocio.
           EVALUATE WS-REPLICA-ASIG
               WHEN "TF01"
      *            EXEC SQL
      *                INSERT INTO TF01 (ID_LOTE, ESTADO, DATOS_TX,
      *                REPLICA_NO, CUENTA, MONTO)
      *                VALUES (:WS-ID-LOTE-SQL, :WS-ESTADO-SQL,
      *                :WS-DATOS-TX-SQL, :WS-REPLICA-SQL,
      *                :WS-CUENTA-SQL, :WS-MONTO-SQL)
      *            END-EXEC
