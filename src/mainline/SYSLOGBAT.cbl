       ...
       PROGRAM-ID. SYSLOG.
      *================================================================*
      * MODULO: SYSLOG (Archivo SYSLOGBAT.cbl para evitar sobreescribir)
      * USO: Intercepta logs internos de ocsql.dll (esqlOC)            *
      *      Redirige los traces de pantalla a un archivo log en docs. *
      *================================================================*
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT AUDIT-FILE ASSIGN TO "..\docs\logs\ocsql_audit.log"
